...
const MCP_NAME_KEYWORDS: Record<string, string[]> = {
 ...
 */
export function matchMcpKeywords(mcpName: string, mcpDescription: string): string[] {
...
export function calculateHybridScore(
  ...
  keywordWeight: number = 0.6  // 키워드 가중치를 높임
): number {
